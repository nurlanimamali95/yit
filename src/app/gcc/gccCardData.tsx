export const gccData = [
	...
	},
	{
		...
		description:
			"China - Terracotta Warriors, Forbidden City, Eco-schools in China, as well as some phrases in Chinese language.",
		details:
