export const donatePackages = [
	...
	},
	{
      ...
      -  3D Theatres Books for children in Azerbaijan, Georgia, Latvia, and Sweden ( 2026).
      - English Through Experience Books on Science, Social Studies, Cooking, Drama, and Global Citizenship  ( 2026).
      - 33 Games for Teaching English Through Drama - extra curriculum material for primary school teachers (Cambridge and IB Curriculums)  ( 2025).
      - 3D Theatres Board game ( 2025).
